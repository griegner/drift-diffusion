...
\column{0.5\textwidth}
\visible{\includegraphics[width=0.8\textwidth]{docs/slides/figures-04MAR2025/toc.png}}
\end{columns}
\vfill\centering
...
\begin{frame}{Experimental Design}
    \centering
    \includegraphics[width=1\textwidth]{docs/slides/figures-04MAR2025/experimental-design.png}
...
\begin{frame}{Brain and Behavior}
    \includegraphics[width=1\textwidth]{docs/slides/figures-04MAR2025/brain-behavior.png}
\end{frame}

% slide %
\begin{frame}{Drift Diffusion Model}
    \includegraphics[width=1\textwidth]{docs/slides/figures-04MAR2025/ddm-intuition.png}
\end{frame}
...
\begin{frame}{Maximum Likelihood Estimator}
    \includegraphics[width=1\textwidth]{docs/slides/figures-04MAR2025/mle.png}
\end{frame}
...
\textbf{Setting}: $a=0.83, v=0.79$, $N=1000$ repeats, $T=900$ trials
    ...
    \includegraphics[width=1\textwidth]{docs/slides/figures-04MAR2025/simulation-results.png}
\end{frame}
...
\includegraphics[width=1\textwidth]{docs/slides/figures-04MAR2025/nonstationarity.png}
